...
function calc_rmsd_freq_MD()
    ...
    for pred_radius in pred_radii
        ...
        @save "../data/viterbi/test_radius_$(test_radius)_sigma_$(sigma_noise)/pred_radius_$(pred_radius)/sharpness_$(sharpness)/q_$(nq)/rmsds_rand_no_rotate.bson" rmsds_arr
    end 
end
